export const EmailTemplate = (otp, name) => `<!DOCTYPE html>
<html lang="en">
      ...
      ">
        <header>
            <table style="width: 100%;">
                <tbody>
                    <tr style="height: 0;">
                        <td>
                            <h1 style="color: #fff;">PR-FINAL</h1>
                        </td>
        ...
        <main>
          ...
          ">
              ...
              ">
                        Thank you for choosing PR-FINAL. Use the following OTP
          ...
          ">
                Need help? Ask at
                <a href="#" style="color: #499fb6; text-decoration: none;">PR.FINAL@gmail.com</a>
                or visit our
